...
class BlogTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
     ...
     * @test
     */
    public function getImgaeReturnsInitialValueForFileReference()
    {
        self::assertEquals(
            null,
            $this->subject->getImgae()
        );
    }
     ...
     * @test
     */
    public function setImgaeForFileReferenceSetsImgae()
    {
        $fileReferenceFixture = new \TYPO3\CMS\Extbase\Domain\Model\FileReference();
        $this->subject->setImgae($fileReferenceFixture);
