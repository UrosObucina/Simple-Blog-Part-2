...
plugin.tx_simpleblog_simplebloglist {
    view {
        ...
        templateRootPaths.1 = {$plugin.tx_simpleblog_simplebloglist.view.templateRootPath}
        partialRootPaths.0 = EXT:simpleblog/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_simpleblog_simplebloglist.view.partialRootPath}
        layoutRootPaths.0 = EXT:simpleblog/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_simpleblog_simplebloglist.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_simpleblog_simplebloglist.persistence.storagePid}
        #recursive = 1
    }
    features {
